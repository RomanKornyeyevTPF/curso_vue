<template>
  ...
  <section v-else class="flex flex-col justify-center items-center w-screen h-screen fade-in">
    ...
    <div class="h-20">
      ...
      <button
        ...
        class="cursor-pointer text-white font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 transition-all
        bg-blue-700 dark:bg-blue-600
        hover:bg-blue-800 dark:hover:bg-blue-700
        active:bg-blue-900 dark:active:bg-blue-800"
      >
        Jugar de nuevo
      </button>
    </div>
